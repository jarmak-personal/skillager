...
class SkillagerCoreTests(unittest.TestCase):
    ...
    def test_working_skill_covers_agent_selection_and_owner_library_work(self) -> None:
        ...
        self.assertIn("skillager where <lib-skill> --json", text)
        self.assertIn("skillager reconcile [<skill-id>] --agent codex --json", text)
        self.assertIn("skillager sync --agent codex --json", text)
