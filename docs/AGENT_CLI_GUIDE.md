...
- You may add available skills to project-local tags and materialize scoped router/stub/native exposure after the user states their task. Report what changed.
