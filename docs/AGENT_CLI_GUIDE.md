...
- Treat `library init`, `library new`, `library accept`, `import ... --yes`, and `edit --open` as user-authorized mutations. Do not run them merely because a pending or useful external skill is discovered.
